...
- story-event E batch 14 延續 `劉備`、`漢朝` 的既有臺灣三國志字形；`群雄`、`復興`、`平安`、`冷落` 是普通歷史／敘事用語，不新增專有名詞；`卻` 使用 E-specific licensed glyph map。E:024／E:025 維持 `ai_review`，待自然結局畫面與人工終審。
- story-event E batch 15 延續 `劉備` 的既有臺灣三國志字形；`刺客`、`安寧`、`信念`、`大意`、`防備` 是普通劇情／歷史敘事用語，不新增專有名詞；`等`、`亂` 沿用 E-specific licensed glyph map。E:026／E:027 維持 `ai_review`，待自然結局畫面與人工終審。
- story-event E batch 16 延續 `劉備`、`董卓` 的既有臺灣三國志人物字形；`宮廷`、`貪欲`、`官員`、`交易`、`財利`、`重課`、`節約`、`浪費` 是普通政治／歷史敘事用語，不新增專有名詞。E:028／E:029 維持 `ai_review`，待自然結局畫面與人工終審。
- story-event E batch 17 延續 `劉備`、`獻帝`、`孫權` 的既有臺灣三國志人物字形；`皇叔` 是人物稱號，`重建`、`威勢`、`尊貴` 是普通歷史敘事用語；`權` 使用 E-specific licensed glyph map。E:030／E:031 維持 `ai_review`，待自然結局畫面與人工終審。
- story-event E batch 18 延續 `劉備`、`漢王朝`、`桃園結義` 的既有臺灣三國志字形；`民生`、`思念`、`誓言`、`志業`、`安詳` 是普通劇情／歷史敘事用語，不新增專有名詞。E:000／E:001 維持 `ai_review`，待自然結局畫面與人工終審。
