...
- [x] 以 `strip_translations.rb` 產生不含 `source` 的提交帳本；二十三批共 98 筆已通過 schema、
...
- [x] 先完成 story-event E 的劇情小批次 `E:002`、`E:011`、`E:032`、`E:003`、`E:004`、`E:005`、`E:006`、`E:007`、`E:008`、`E:009`、`E:010`、`E:012`、`E:013`、`E:014`、`E:015`、`E:016`、`E:017`、`E:018`、`E:019`、`E:020`、`E:021`、`E:022`、`E:023`；
  ...
  batch 7 的兩筆 existing-codepage record、batch 8–13 各兩筆 E-specific custom record 也已通過相同 gate；公開流程交叉證據已記錄，仍須取得自然 E writer／畫面證據
...
- [x] 從 clean ROM 建立兩個 existing-codepage Table B、兩個 existing-codepage pool-A、
  ...
  custom pool-A 三個 bounded BPS，以及 story-event E 三個 existing-codepage 加九個
  E-specific custom bounded BPS；二十三個 BPS 全部套用後 byte-for-byte equality，並由
  bounded verifier 重新抽取 6/6、19/19、9/9、1/1、12/12、5/5、6/6、12/12、31/31、
  6/6、story E existing 2/2、1/1、2/2、custom 2/2、1/1、1/1、2/2、2/2、2/2、2/2、2/2、2/2、2/2 相符；全池／全 ROM
  round-trip 仍待完成。
