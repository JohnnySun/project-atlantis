...
- M5.5 後已完成八筆 bounded consistency／字型／單行版面 review；八筆維持 provisional wording，`重金礦` 已由兩個臺灣社群來源交叉支持但仍待人工術語核准，八筆仍為 `ai_draft`。這是可審核的 static review，不等同人工定稿。
