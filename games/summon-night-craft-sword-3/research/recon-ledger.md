...
| `TRANSLATION-001` | 劇情、支線、夥伴、鍛造、戰鬥、道具的大批翻譯 | `blocked` | 目前完成五筆 bounded `ai_draft` static candidate；完整 VM／排版／runtime／人工審核仍未完成 | 先完成五筆 target 的人工／字型／runtime review，再依 resource capacity 選下一個有界批次；不把 static candidates 升格為全遊戲 |
