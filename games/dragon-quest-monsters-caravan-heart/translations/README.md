...
截至 2026-08-16，已建立五筆 source-free bounded ledger；clean consumer、glyph table、mixed-byte pair
...
`tools/build_bounded_batches.py` 會從 clean ROM 分別重建五批並拒絕 range conflict；cumulative
