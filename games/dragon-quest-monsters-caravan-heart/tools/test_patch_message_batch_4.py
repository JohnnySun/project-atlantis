...
import patch_message_batch_4 as module


class MessageBatch4Test(unittest.TestCase):
    ...
    def test_target_round_trip_fits_and_preserves_ff(self) -> None:
        from verify_message_batch_4 import decode_target
    ...
    def test_allowed_ranges_cover_message_and_each_tile(self) -> None:
        from verify_message_batch_4 import allowed_ranges
